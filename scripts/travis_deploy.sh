...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "ChristianLieven/wintest" ]]; then
...
echo "Your new report will be visible at https://ChristianLieven.github.io/wintest in a moment."
